...
def menu():
    ...
    background = pygame.image.load('assets/kyoko.png')  # Carga la imagen de fondo del menú
    background = pygame.transform.scale(background, (450, 450))  # Redimensiona la imagen
    background_music = pygame.mixer.Sound('assets/0.mp3')  # Carga la música del menú
...
def default_mode():
    ...
    background = pygame.image.load('assets/tictactoe_background.png')  # Carga la imagen de fondo del juego
    background = pygame.transform.scale(background, (450, 450))  # Redimensiona la imagen
    circle = pygame.image.load('assets/circle.png')  # Carga la imagen del círculo
    circle = pygame.transform.scale(circle, (125, 125))  # Redimensiona la imagen del círculo
    x = pygame.image.load('assets/x.png')  # Carga la imagen de la 'X'
    x = pygame.transform.scale(x, (125, 125))  # Redimensiona la imagen de la 'X'
    background_music = pygame.mixer.Sound('assets/1.wav')  # Carga la música para el modo predeterminado
    background_music.play(loops=-1)  # Reproduce la música en bucle
    return background, circle, x, background_music

def rcg_mode():
    # Cargar y configurar recursos para el modo rcg
    background = pygame.image.load('assets/rcg_background.png')  # Carga la imagen de fondo del modo rcg
    background = pygame.transform.scale(background, (450, 450))  # Redimensiona la imagen
    circle = pygame.image.load('assets/misako.png')  # Carga la imagen del círculo para el modo rcg
    circle = pygame.transform.scale(circle, (112, 108))  # Redimensiona la imagen del círculo
    x = pygame.image.load('assets/kyoko.png')  # Carga la imagen de la 'X' para el modo rcg
    x = pygame.transform.scale(x, (112, 112))  # Redimensiona la imagen de la 'X'
    background_music = pygame.mixer.Sound('assets/2.mp3')  # Carga la música para el modo rcg
    background_music.play(loops=-1)  # Reproduce la música en bucle
    return background, circle, x, background_music
...
def load_result_image():
    ...
    result_image = pygame.image.load('assets/kyoko.png')  # Carga la imagen de resultado
