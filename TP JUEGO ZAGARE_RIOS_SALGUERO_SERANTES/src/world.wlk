...
object world {
	...
	method quedanEnemigos() {
		return habitacion_actual.entidades().any({entidad => entidad.entityType() == "enemy"})
	}
}
...
object HabitacionNormal inherits TipoHabitacion {
	...
	override method templates() = [
		new Template(entradas = [
			[2, new Position(x = 5, y = 7)],
			[2, new Position(x = 9, y = 7)]
		]),
		new Template(entradas = [
			...
			[0, new Position(x = 5, y = 5)],
			[0, new Position(x = 9, y = 9)],
			[0, new Position(x = 9, y = 5)],
			[0, new Position(x = 5, y = 9)]
		]),
		new Template(entradas = [
		...
		new Template(entradas = [
			[0, new Position(x = 1, y = 1)],
			[0, new Position(x = 1, y = 14)],
			[0, new Position(x = 14, y = 1)],
			[0, new Position(x = 14, y = 14)],
			[1, new Position(x = 7, y = 7)]
		]),
		new Template(entradas = [
			[0, new Position(x = 7, y = 4)],
			[0, new Position(x = 7, y = 7)],
			[0, new Position(x = 7, y = 10)],
			[1, new Position(x = 5, y = 7)],
			[1, new Position(x = 9, y = 7)]
		]),
		new Template(entradas = [
			[0, new Position(x = 0, y = 0)],
			[0, new Position(x = 1, y = 1)],
			[0, new Position(x = 2, y = 2)],
			[0, new Position(x = 3, y = 3)],
			[0, new Position(x = 4, y = 4)],
			[0, new Position(x = 5, y = 5)],
			[0, new Position(x = 6, y = 6)],
			[0, new Position(x = 7, y = 7)],
			[0, new Position(x = 8, y = 8)],
			[0, new Position(x = 9, y = 9)],
			[0, new Position(x = 10, y = 10)],
			[0, new Position(x = 11, y = 11)],
			[0, new Position(x = 12, y = 12)],
			[0, new Position(x = 13, y = 13)],
			[0, new Position(x = 14, y = 14)],
			[0, new Position(x = 15, y = 15)]
		]),
		new Template(entradas = [
			[1, new Position(x = 1, y = 1)],
			[1, new Position(x = 1, y = 14)],
			[1, new Position(x = 14, y = 1)],
			[1, new Position(x = 14, y = 14)]
		]),
		new Template(entradas = [
			[0, new Position(x = 5, y = 7)],
			[0, new Position(x = 9, y = 7)],
...
class Puerta{
	const property entityType = "door"
	...
	method image() {
		if (world.quedanEnemigos()) {
			return "sprites/door/door_closed.png"
		}
